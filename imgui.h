...
namespace ImGui
{
    ...
    // CollapsingHeaderEx was added to ImGui. Is not available at standard ImGui version.
    IMGUI_API bool          CollapsingHeaderEx(const char* str_id, const char* label, ImGuiTreeNodeFlags flags = 0);  // if returning 'true' the header is open.
